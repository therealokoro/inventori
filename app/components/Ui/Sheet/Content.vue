  ...
  <UiSheetPortal :to="to">
    ...
    >
      <slot>
        ...
        <div class="overflow-y-auto border-b pt-4">
          <slot name="content" />
        </div>
        <slot name="footer" />
      </slot>
...
const styles = tv({
  base: "bg-background data-[state=closed]:animate-out data-[state=open]:animate-in fixed z-50 flex flex-col shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  variants: {
    side: {
